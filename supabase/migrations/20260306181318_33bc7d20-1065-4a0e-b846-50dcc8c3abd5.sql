...
BEGIN
  -- ============================================================
  -- ETAPA 1: Buscar venda ativa do lote e validar registro VENDA
  -- ============================================================
  ...
  IF v_venda.id IS NOT NULL THEN
    ...
    IF v_valor_esperado > 0 THEN
      ...
      -- Remover registros de VENDA duplicados (manter apenas o primeiro)
  ...
  -- ============================================================
  -- ETAPA 2: Recalcular saldos sequencialmente
  -- (Não exclui duplicidades - apenas recalcula saldos)
  -- ============================================================
  FOR v_registro IN 
